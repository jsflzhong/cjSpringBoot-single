...
import com.michael.springBoot.domain.Permission;
import com.michael.springBoot.domain.Role;
...
public class MyShiroRealm extends AuthorizingRealm {
     ...
     * 经测试：本例中该方法的调用时机为需授权资源被访问时.例如:jsp页面使用<shiro:hasRole></shiro:hasRole>或<shiro:hasPermission></shiro:hasPermission>等标签时,每一个都会进来一次.
