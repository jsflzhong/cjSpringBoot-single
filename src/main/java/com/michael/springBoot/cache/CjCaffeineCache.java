package com.michael.springBoot.cache;
...
public class CjCaffeineCache {
    ...
    Cache<String, DataValue> cache = Caffeine.newBuilder()
            ...
            .removalListener((RemovalListener<String, DataValue>) (key, value, cause)
                    -> System.out.println("@@@Removing key:" + key + ",cause:" + cause.toString()))
            .build();
     ...
     * The complete signature of the get() function in Caffeine: V get(@Nonnull K var1, @Nonnull Function<? super K, ? extends V> var2);
