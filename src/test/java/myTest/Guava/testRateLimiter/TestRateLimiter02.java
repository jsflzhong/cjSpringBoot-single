 ...
 */
public class TestRateLimiter02 {

    public static void main(String[] args) {
        TestRateLimiter02 testRateLimiter02 = new TestRateLimiter02();

        testRateLimiter02.testRateLimiter();
        testRateLimiter02.testListenableFuture();
    }
